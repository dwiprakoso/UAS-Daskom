...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto" style="color: #fff; font-weight: bold;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link me-4" href="#">Tentang</a>
                    </li>
                    <li class="nav-item">
    ...
    <section id="content">
        <div class="jumbotron text-center">
            <img src="img/tentang.jpeg" width="200" class="img-thumbnail rounded-circle" alt="heroimage">
            <img src="" alt="">
            <h1 class="display-4"><b>Dwi Prakoso</b></h1>
            <p class="lead">Mahasiswa | S1-Teknik Informatika</p>
            <hr class="my-4">
            <div class="container">
                <div class="row justify-content-center text-center mt-4" style="font-size:18px;">
                    <div class="col-6 mt-5">
                    <p>Website ini dibuat untuk memenuhi Ujian Akhir Semester mata kuliah Dasar Pemrograman. Diharapkan website ini akan terus berkembang hingga berfungsi sebagaimana mestinya.</p>
                    </div>
                </div>
            </div>
        </div>
